  ...
  <body>
    <div class='navbar navbar-default navbar-static-top'>
      <div class='container-fluid'>
        <div class="navbar-header">
          ...
          <a class='navbar-brand' href='index.php'>WiFind</a>
        </div>
      ...
      <div class='row'>
		...
		<div class='col-md-4'>
          <div class='well'>
			...
			<input type="hidden" id="lat" name="lat" size="30" maxlength="30" value="<?php echo $latitude; ?>" class="form-control" placeholder="Latitude">
			<input type="hidden" id="long" name="long" size="30" maxlength="30" value="<?php echo $longitude; ?>" class="form-control" placeholder="Longitude">
    ...
    <script type='text/javascript'>
		...
		function calculateAndDisplayRoute(tujuan) {
			...
			var modeSelect = document.getElementById('mode-select'); // Ambil elemen dropdown

			var selectedMode = modeSelect.value; // Ambil nilai travel mode yang dipilih
		

			directionsService.route({
				origin: asal,
				destination: tujuan,
				travelMode: selectedMode // Gunakan travel mode yang dipilih
